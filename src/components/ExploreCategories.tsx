// components/ExploreCategories.tsx
...
const categories: CategoryCardProps[] = [
  ...
  },
  {
    ...
    description: 'Dive into a vast collection of cosmic images and videos.',
    href: '/media-library',
    icon: '📸',
  },
  {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {categories.map((category) => (
          <Link href={category.href} key={category.title}>
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg hover:bg-gray-700 transition-all duration-300 transform hover:scale-105 cursor-pointer flex flex-col items-center text-center">
              <span className="text-5xl mb-4" role="img" aria-label={category.title}>{category.icon}</span>
